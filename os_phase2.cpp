...
private:
    ...
    void go_to_end();
    void reset_memory();
    PCB init_PCB(string file_content); //function initializes a PCB structure.

    int ALLOCATE(); //function allocates memory for a program
    void SIMULATION(); //function appears to simulate the execution of a program

    void update_page_table(int); // function updates the page table
    int ADDRESS_MAP(int VA1); //function maps a virtual address to a physical address.
    void set_pt();
